...
//get user
app.get("/get-user", authonticationToken,async(req,res)=>{
    const {user}=req.user;
...
app.put("/update-note-pinned/:noteId", authonticationToken, async (req, res) => {
    const noteId=req.params.noteId;
...
//Search notes
app.get("/search-notes/", authonticationToken, async (req, res) => {
    const {user}=req.user;
